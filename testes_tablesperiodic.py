...
if __name__ == "__main__":
    ...
    def command(text):
        ...
        size  = len(text)
        if size == 2:
            nome_elemento = text[0].upper() + text[1]
            ...
            if pegando_valencia == 'IA':
                ...
                showinfo("search command", "Nome do Elemento:%s" % traducao.text)
                showinfo("search command","Grupo na tabela periodica:%s"%pegando_valencia)
